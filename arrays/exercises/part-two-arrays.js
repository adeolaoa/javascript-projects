...
cargoHold.pop(cargoHold.length-1);
console.log(cargoHold);

//3) Remove the first item from the array with shift. Print the element removed and the updated array.
//cargoHold.shift(0);
let rem = []
rem = cargoHold.shift(0);// prints the element removed
console.log(rem);
//console.log(cargoHold.shift(0)); // prints the element removed
console.log(cargoHold); // prints the updated array
...
console.log(`The final array is ${cargoHold} with length ${cargoHold.length}.`);
